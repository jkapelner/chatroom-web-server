...
define('BLOG_DISPLAY_LIMIT', 20); //limit on how many projects are displayed at once
...
return array(
	...
	/**
	 * ssl_enable - is SSL enabled on the site - set true if it is and you want to use ssl for secure features like login, set false if it isnt
	 */
	'ssl_enable'  => false,
    
	/**
	 * title_prefix - prefix text to show as part of every page in the browser's title bar
	 */
    'title_prefix' => 'ChatRoom',
	...
	'security' => array(
		'csrf_autoload'    => false,
		'csrf_token_key'   => 'ChatroomCsrfToken',
		'csrf_expiration'  => 0,
	...
	'cookie' => array(
		...
		'domain'      => isset($_SERVER['COOKIE_DOMAIN']) ? $_SERVER['COOKIE_DOMAIN'] : null,
