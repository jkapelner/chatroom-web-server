...
class Warden
{
   ...
   * @return bool
   */
  public static function force_login($username_or_email_or_id, $check_confirmation = false)
  {
    return static::driver()->force_login($username_or_email_or_id, $check_confirmation);
  }
  ...
  public static function authorize($action, $resource, array $options = array())
  {
    ...
    if (static::cannot($action, $resource)) {
      ...
      throw new AccessDenied($message, $action, $resource);
    }
  }
  ...
  {
    \Event::register('warden.after_set_user', $callback);
  }
  ...
  {
      \Event::register('warden.after_authentication', $callback);
  }
  ...
  {
    \Event::register('warden.before_logout', $callback);
  }
  ...
  {
    \Event::register('warden.after_authorization', $callback);
  }
