...
CREATE TABLE IF NOT EXISTS `profiles` (
  ...
  `user_id` int(11) unsigned NOT NULL COMMENT 'Unique user id',
  `displayname` varchar(32) NOT NULL COMMENT 'User display name',
  `picture` varchar(255) DEFAULT NULL COMMENT 'User profile picture filename',
  `zipcode` varchar(10) DEFAULT NULL COMMENT 'User zip code',
  PRIMARY KEY (`id`),
