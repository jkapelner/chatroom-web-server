...
class Warden
{
  ...
  public function run()
  {
    ...
    \Cli::write(static::_bold_text('Copyright (c) 2013 Andrew Wayne'));
    \Cli::write(static::_bold_text('================================================================'));
  ...
  public function rememberable($new = false)
  {
    $fields = array(
    ...
    if (!$new) {
      ...
      \Config::set('warden.rememberable.in_use', $delete ? false : true);
      $this->_save_config();
    }

    $this->_alter_or_return_fields('Rememberable', $fields, $new);
  ...
  public function recoverable($new = false)
  {
    ...
    $this->_alter_or_return_fields('Recoverable', $fields, $new);
  ...
  public function confirmable($new = false)
  {
    ...
    $this->_alter_or_return_fields('Confirmable', $fields, $new);
  ...
  public function trackable($new = false)
  {
    ...
    $this->_alter_or_return_fields('Trackable', $fields, $new);
  }
  ...
  public function lockable($new = false)
  {
    ...
    $this->_alter_or_return_fields('Lockable', $fields, $new);
...
$runtime_header
  ...
  -rem, [--rememberable]  # Add/remove remember-me feature
  -t, [--trackable]       # Add/remove tracking user account sign in info
  -rc, [--recoverable]    # Add/remove reset passwords feature
...
HELP;
  ...
  private function _setup_config()
  {
    ...
    if (\Cli::option('rem') || \Cli::option('rememberable') || $all) {
      \Config::set('warden.rememberable.in_use', true);
    }

    if (\Cli::option('rc') || \Cli::option('recoverable') || $all) {
